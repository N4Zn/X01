...
/// <summary>
/// View for the TongHop game - handles all UI display and user interaction.
/// Cloned from AddNumber game.
/// </summary>
public class TongHopGameView : MonoBehaviour
{
    [Header("=== Common UI ===")]
    ...
    private void PositionOverlayOnBox(GameObject overlay, Transform boxContainer)
    {
        ...
        Transform box = boxContainer.parent;
        Transform panel = box.parent;
